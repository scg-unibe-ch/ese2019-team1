...
let SettingsPage = class SettingsPage {
    constructor(navCtrl, router, auth, toastCtrl, userHandler) {
        ...
        this.userHandler.readUser(uid).then(usr => this.isAdmin = usr.isAdmin);
    }
    changeState(card) {
        card[''] = card[''] !== true;
    }
    ...
    adminPage() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.navCtrl.navigateForward('home/admin-page');
        });
    }
